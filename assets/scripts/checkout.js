...
function checkout() {
  ...
  alert('Compra finalizada com sucesso via ' + metodoPagamento.value + '!');
...
const usernome = JSON.parse(localStorage.getItem('usuarioLogado'));
const divnomeusuario = document.getElementById('divnomeusuario');
divnomeusuario.innerHTML = `<p>${usernome.nome}</p>`;}
nomedeusuario();